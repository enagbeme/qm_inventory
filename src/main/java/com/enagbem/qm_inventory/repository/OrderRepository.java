...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT oi.product.productId, oi.product.name, oi.product.category.name, " +
            "SUM(oi.quantity), SUM(oi.unitPrice), SUM(oi.quantity * oi.unitPrice), " +
            "(SUM(oi.quantity * oi.unitPrice) - SUM(oi.quantity * oi.product.costPrice)) " +
